...
public class recycleGalleryAdapter extends RecyclerView.Adapter<recycleGalleryAdapter.galleryViewHolder> {
    private ArrayList<CustomImage> customImages = new ArrayList<>();
    private Context context;
    public recycleGalleryAdapter(Context context, ArrayList<CustomImage> customImages ){
    ...
    public void onBindViewHolder(galleryViewHolder holder, int position) {
        Glide.with(context).load(customImages.get(position).getImageByte())
                .asBitmap()
