...
public class recycleGalleryClothAdapter extends RecyclerView.Adapter<recycleGalleryClothAdapter.galleryViewHolder> {
    private ArrayList<CustomImage> customImages = new ArrayList<>();
    private Context context;

    public recycleGalleryClothAdapter(Context context, ArrayList<CustomImage> customImages ){
